...
contains "$SKILL" "~/.codex/superpowers/state-index/<repo-id>/" "global storage layout"
contains "$SKILL" 'CODEX_HOME="${CODEX_HOME:-$HOME/.codex}"' "CODEX_HOME default"
...
not_contains "$SKILL" 'Store project-local state under `.superpowers/state/`' "old project-local storage rule"
